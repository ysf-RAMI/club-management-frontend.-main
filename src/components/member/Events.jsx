                ...
                <div className="border-b border-gray-200">
                    <nav className="flex space-x-6 px-4">
                        <button
                            ...
                            className={`py-3 px-1 border-b-2 font-medium text-xs transition-colors duration-200 cursor-pointer ${activeTab === 'upcoming'
                        ...
                        <button
                            ...
                            className={`py-3 px-1 border-b-2 font-medium text-xs transition-colors duration-200 cursor-pointer ${activeTab === 'past'
                                ? 'border-purple-500 text-purple-600'
                                : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                                }`}
                        >
