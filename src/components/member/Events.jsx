...
export default function Events() {
    ...
    const EventCard = ({ event, isPast = false }) => (
        <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300 border border-gray-100">
            ...
            {!isPast && !event.canRegister && (
                <button className="w-full bg-gray-300 text-gray-500 font-medium py-3 px-4 rounded-lg cursor-not-allowed">
                    Registration Closed
                </button>
            )}
        </div>
                ...
                <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 rounded-xl shadow-lg">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-purple-100 text-lg">Manage and view your joined events</p>
                        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <div className="flex items-center">
                            <label htmlFor="clubs" className="text-sm font-medium text-gray-700 mr-2">
                                Club:
                            </label>
                            <select 
                                id="clubs" 
                        ...
                        <div>
                            ...
                            {upcomingEvents.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-xl font-medium text-gray-500 mb-2">No upcoming events</h3>
                    ...
                    {activeTab === 'past' && (
                        <div>
                            ...
                            {pastEvents.length > 0 ? (
                                ...
                                <div className="text-center py-12">
                                    <FontAwesomeIcon icon={faCalendarAlt} className="text-gray-300 text-6xl mb-4" />
                                    <h3 className="text-xl font-medium text-gray-500 mb-2">No past events</h3>
